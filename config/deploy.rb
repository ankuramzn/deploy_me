...
set :use_sudo, true
set :scm, :git
set :repository,  "git@github.com:ankuramzn/deploy_me.git"
set :deploy_via, :copy
...
role :web, "ec2-174-129-84-247.compute-1.amazonaws.com"                          # Your HTTP server, Apache/etc
role :app, "ec2-174-129-84-247.compute-1.amazonaws.com"                          # This may be the same as your `Web` server
role :db,  "ec2-174-129-84-247.compute-1.amazonaws.com", :primary => true # This is where Rails migrations will run
